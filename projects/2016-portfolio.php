			...
			<div id="favorite-color">
				<div class="large" id="color-swatches">
					<form class="ac-custom ac-radio ac-drop">
						<ul>
							<li>
								<input id="mint" name="color" type="radio" value="mint"><label class="radio mint" for="mint"><img id="cat1" src="http://ashdoeswebsites.com/2016/wp-content/uploads/2017/02/cat1.png" style="display: none;"></label><svg viewbox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"></svg>
							</li>
							<li>
								<input id="pink" name="color" type="radio" value="pink"><label class="radio pink" for="pink"><img id="cat2" src="http://ashdoeswebsites.com/2016/wp-content/uploads/2017/02/cat2.png" style="display: none;"></label><svg viewbox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"></svg>
							</li>
						</ul>
					</form>
				</div>
